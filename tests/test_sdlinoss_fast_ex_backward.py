...
from ossm.models._sdlinoss_scan import _SdlinossExFn
from ossm.models._sdlinoss_scan_fast import SdlinossExFastFn, has_fast_kernels
...
def test_fast_ex_backward_matches_reference(length: int,
                                            batch: int,
                                            ssm: int,
                                            dtype: torch.dtype,
                                            shape_tag: str) -> None:
    ...
    out_fast = SdlinossExFastFn.apply(A_fast, G_fast, step_fast, bu_fast)
    ...
    out_ref = _SdlinossExFn.apply(A_ref, G_ref, step_ref, bu_ref)
