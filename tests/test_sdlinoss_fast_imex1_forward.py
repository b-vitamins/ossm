...
def test_fast_imex1_forward_matches_reference(length: int,
                                              batch: int,
                                              ssm: int,
                                              dtype: torch.dtype,
                                              shape_tag: str) -> None:
    ...
    output = run_sdlinoss_fast("imex1", A_param, G_param, step_param, bu)
    ...
    reference = _SdlinossImex1Fn.apply(A_ref, G_ref, step_ref, bu)
