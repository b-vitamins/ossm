...
from ossm.models._sdlinoss_scan import _SdlinossImex2Fn
from ossm.models._sdlinoss_scan_fast import SdlinossImex2FastFn, has_fast_kernels
...
def test_fast_imex2_backward_matches_reference(length: int,
                                               batch: int,
                                               ssm: int,
                                               dtype: torch.dtype,
                                               shape_tag: str) -> None:
    ...
    out_fast = SdlinossImex2FastFn.apply(A_fast, G_fast, step_fast, bu_fast)
    ...
    out_ref = _SdlinossImex2Fn.apply(A_ref, G_ref, step_ref, bu_ref)
