...
from ossm.models._sdlinoss_scan import _SdlinossImex1Fn
from ossm.models._sdlinoss_scan_fast import SdlinossImex1FastFn, has_fast_kernels
...
def test_fast_imex1_backward_matches_reference(length: int,
                                               batch: int,
                                               ssm: int,
                                               dtype: torch.dtype,
                                               shape_tag: str) -> None:
    ...
    out_fast = SdlinossImex1FastFn.apply(A_fast, G_fast, step_fast, bu_fast)
    ...
    out_ref = _SdlinossImex1Fn.apply(A_ref, G_ref, step_ref, bu_ref)
