...
class _LRUScanFn(Function):
    """Autograd-friendly wrapper around the optimized LRU scan."""
    ...
    def forward(ctx, lambda_bar: Tensor, b_seq: Tensor) -> Tensor:  # type: ignore[override]
        ...
        ext_result = try_run_lru_scan(lambda_bar, b_seq)
        states: Tensor
...
class LRULayer(nn.Module):
    ...
    def forward(self, inputs: Tensor) -> Tensor:
        ...
        states_seq = cast(Tensor, _LRUScanFn.apply(lambda_diag, bu_seq))
