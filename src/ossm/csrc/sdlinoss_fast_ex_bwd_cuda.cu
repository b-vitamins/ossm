...
__global__ void ex_backward_kernel(
...
void launch_backward_kernel(const Strides3& A_stride,
                            ...
                            dim3 block,
                            cudaStream_t stream) {
  ex_backward_kernel<scalar_t, VL, VB, VM, TILE><<<grid, block, 0, stream>>>(
      A,
      A_stride.sL,
      A_stride.sB,
      A_stride.sM,
...
void sdlinoss_fast_ex_backward_cuda_complex64(int tile,
                                              int vary_mask,
                                              const Strides3& A_stride,
                                              const Strides3& G_stride,
                                              const Strides3& step_stride,
...
void sdlinoss_fast_ex_backward_cuda_complex128(int tile,
                                               int vary_mask,
                                               const Strides3& A_stride,
                                               const Strides3& G_stride,
                                               const Strides3& step_stride,
