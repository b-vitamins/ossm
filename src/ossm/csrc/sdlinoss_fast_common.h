...
C10_HOST_DEVICE inline FastPair<value_t> combine(
  ...
  out.m00 = fmaf(p2.m01, p1.m10, p2.m00 * p1.m00);
  out.m01 = fmaf(p2.m01, p1.m11, p2.m00 * p1.m01);
  out.m10 = fmaf(p2.m11, p1.m10, p2.m10 * p1.m00);
  out.m11 = fmaf(p2.m11, p1.m11, p2.m10 * p1.m01);
