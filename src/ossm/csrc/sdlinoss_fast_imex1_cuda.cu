...
__global__ void imex1_build_tile_summaries_kernel(
  ...
  for (int64_t tile = 0; tile < num_tiles; ++tile) {
    ...
    for (int64_t k = 0; k < tile_len; ++k) {
      ...
      step_coeff_imex1<value_t>(A_val, G_val, dt, alpha, beta, gamma);
...
__global__ void imex1_prefix_tiles_per_series_kernel(
...
template <typename scalar_t, bool VL, bool VB, bool VM, int TILE>
__global__ void imex1_expand_tiles_write_states_kernel(
    const typename scalar_t::value_type* __restrict__ A,
    int64_t AsL,
    int64_t AsB,
    int64_t AsM,
...
template <typename scalar_t, bool VL, bool VB, bool VM, int TILE>
__global__ void imex1_expand_tiles_write_x_kernel(
    const typename scalar_t::value_type* __restrict__ A,
    int64_t AsL,
    int64_t AsB,
    int64_t AsM,
...
void launch_build_kernel(const Strides3& A_stride,
                         ...
                         dim3 block,
                         cudaStream_t stream) {
  imex1_build_tile_summaries_kernel<scalar_t, VL, VB, VM, TILE>
...
void launch_expand_kernel(const Strides3& A_stride,
  ...
  imex1_expand_tiles_write_states_kernel<scalar_t, VL, VB, VM, TILE>
...
template <typename scalar_t, bool VL, bool VB, bool VM, int TILE>
void launch_expand_kernel_xonly(const Strides3& A_stride,
                                const Strides3& G_stride,
                                const Strides3& step_stride,
                                const Strides3& bu_stride,
                                const typename scalar_t::value_type* A,
  ...
  imex1_expand_tiles_write_x_kernel<scalar_t, VL, VB, VM, TILE>
      <<<grid, block, shared_bytes, stream>>>(A,
                                   A_stride.sL,
                                   A_stride.sB,
                                   A_stride.sM,
...
void launch_prefix_kernel(const typename scalar_t::value_type* M00,
  ...
  dim3 grid(series);
  dim3 block(1);
  imex1_prefix_tiles_per_series_kernel<scalar_t, TILE>
...
void dispatch_all_xonly(int vary_mask,
  ...
  switch (vary_mask) {
    case 0:
      launch_expand_kernel_xonly<scalar_t, false, false, false, TILE>(A_stride,
                                                                      G_stride,
                                                                      step_stride,
                                                                      bu_stride,
                                                                      A_ptr,
      ...
      break;
    case 1:
      launch_expand_kernel_xonly<scalar_t, true, false, false, TILE>(A_stride,
                                                                     G_stride,
                                                                     step_stride,
                                                                     bu_stride,
                                                                     A_ptr,
      ...
      break;
    case 2:
      launch_expand_kernel_xonly<scalar_t, false, true, false, TILE>(A_stride,
                                                                     G_stride,
                                                                     step_stride,
                                                                     bu_stride,
                                                                     A_ptr,
      ...
      break;
    case 3:
      launch_expand_kernel_xonly<scalar_t, true, true, false, TILE>(A_stride,
                                                                    G_stride,
                                                                    step_stride,
                                                                    bu_stride,
                                                                    A_ptr,
      ...
      break;
    case 4:
      launch_expand_kernel_xonly<scalar_t, false, false, true, TILE>(A_stride,
                                                                     G_stride,
                                                                     step_stride,
                                                                     bu_stride,
                                                                     A_ptr,
      ...
      break;
    case 5:
      launch_expand_kernel_xonly<scalar_t, true, false, true, TILE>(A_stride,
                                                                    G_stride,
                                                                    step_stride,
                                                                    bu_stride,
                                                                    A_ptr,
      ...
      break;
    case 6:
      launch_expand_kernel_xonly<scalar_t, false, true, true, TILE>(A_stride,
                                                                    G_stride,
                                                                    step_stride,
                                                                    bu_stride,
                                                                    A_ptr,
      ...
      break;
    default:
      launch_expand_kernel_xonly<scalar_t, true, true, true, TILE>(A_stride,
                                                                   G_stride,
                                                                   step_stride,
                                                                   bu_stride,
                                                                   A_ptr,
